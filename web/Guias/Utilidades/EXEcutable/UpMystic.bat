...
IF NOT EXIST "%USERPROFILE%\mystic" (
    ...
    git clone https://chat.whatsapp.com/D690ZsxMPHA2CbNH3nC42y.git "%USERPROFILE%\mystic"
...
git pull https://chat.whatsapp.com/D690ZsxMPHA2CbNH3nC42y.git > git_output.txt
